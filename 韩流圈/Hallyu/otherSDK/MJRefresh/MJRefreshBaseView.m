...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.MJRefreshViewHeight = MJRefreshViewHeight;
        self.MJRefreshFastAnimationDuration = MJRefreshFastAnimationDuration;
        self.MJRefreshSlowAnimationDuration = MJRefreshSlowAnimationDuration;
        
        self.MJRefreshFooterPullToRefresh = MJRefreshFooterPullToRefresh;
        self.MJRefreshFooterReleaseToRefresh  =MJRefreshFooterReleaseToRefresh;
        self.MJRefreshFooterRefreshing = MJRefreshFooterRefreshing;
        self.MJRefreshHeaderPullToRefresh = MJRefreshHeaderPullToRefresh;
        self.MJRefreshHeaderReleaseToRefresh = MJRefreshHeaderReleaseToRefresh;
        self.MJRefreshHeaderRefreshing = MJRefreshHeaderRefreshing;
        }
    return self;
}
