...
- (void)setState:(MJRefreshState)state
{
	...
	switch (state) {
        ...
        {
            // 设置文字
			self.statusLabel.text = self.MJRefreshHeaderPullToRefresh;
        ...
        {
            // 设置文字
            self.statusLabel.text = self.MJRefreshHeaderReleaseToRefresh;
            // 执行动画
            [UIView animateWithDuration:self.MJRefreshFastAnimationDuration animations:^{
        ...
        {
            // 设置文字
            self.statusLabel.text = self.MJRefreshHeaderRefreshing;
