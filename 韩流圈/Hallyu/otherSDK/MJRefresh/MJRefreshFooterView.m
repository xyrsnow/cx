...
- (void)setState:(MJRefreshState)state
{
	...
	switch (state)
    {
        ...
        {
            // 设置文字
            self.statusLabel.text = self.MJRefreshFooterPullToRefresh;
            
            // 刷新完毕
            if (MJRefreshStateRefreshing == oldState) {
                self.arrowImage.transform = CGAffineTransformMakeRotation(M_PI);
                [UIView animateWithDuration:self.MJRefreshSlowAnimationDuration animations:^{
                    self.scrollView.contentInsetBottom = self.scrollViewOriginalInset.bottom;
                }];
            } else {
                // 执行动画
                [UIView animateWithDuration:self.MJRefreshFastAnimationDuration animations:^{
                    self.arrowImage.transform = CGAffineTransformMakeRotation(M_PI);
                }];
            }
        ...
        {
            // 设置文字
            self.statusLabel.text = self.MJRefreshFooterReleaseToRefresh;
        ...
        {
            // 设置文字
            self.statusLabel.text = self.MJRefreshFooterRefreshing;
