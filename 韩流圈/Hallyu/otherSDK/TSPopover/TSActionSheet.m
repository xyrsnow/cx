...
- (void) buildButtons
{
    ...
    for (NSArray *button in buttonsMutableArray)
    {
        ...
        UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];        button.frame = CGRectMake(BORDER, buttonY, self.bounds.size.width-BORDER*2, buttonHeight);
        button.titleLabel.font = [UIFont boldSystemFontOfSize:16];
//        button.titleLabel.minimumFontSize = 6;
        button.titleLabel.adjustsFontSizeToFitWidth = YES;        button.frame = CGRectMake(BORDER, buttonY, self.bounds.size.width-BORDER*2, 20);
